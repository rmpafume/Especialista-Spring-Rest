...
insert into grupo (nome) values ('Gerente'), ('Vendedor'), ('Secretária'), ('Cadastrador'), ('Cliente');

insert into permissao (id, nome, descricao) values (1, 'CONSULTAR_COZINHAS', 'Permite consultar cozinhas');
insert into permissao (id, nome, descricao) values (2, 'EDITAR_COZINHAS', 'Permite editar cozinhas');
insert into permissao (id, nome, descricao) values (3, 'CADASTRAR_COZINHAS', 'Permite cadastrar cozinhas');

insert into grupo_permissao (grupo_id, permissao_id) values (1, 1), (1, 2), (1, 3), (2, 2), (3, 1), (4, 1), (4, 3);

insert into usuario_grupo (usuario_id, grupo_id) values (1, 1), (1, 2), (2, 2);

insert into restaurante_usuario_responsavel (restaurante_id, usuario_id) values (1, 2), (1, 3), (2, 1), (3, 3);


insert into pedido (id, codigo, subtotal, taxa_frete, valor_total, restaurante_id, usuario_cliente_id, forma_pagamento_id, 
...
values (1, '0099a5f0-0413-483f-b903-5947986da753', 290.90, 5.70, 296.60, 2, 3, 1, 2, 00336100, 'avenida das dores', 200, 'apto 3', 'centro', 'CRIADO', 
'2021-05-20 19:42:07', null, null, null);

insert into item_pedido (id, quantidade, preco_unitario, preco_total, observacao, pedido_id, produto_id) 
values(1, 2, 100, 200, 'pouco molho', 1, 3);

insert into item_pedido (id, quantidade, preco_unitario, preco_total, observacao, pedido_id, produto_id) 
values(2, 1, 90.90, 90.90, 'caprichado no molho', 1, 1);

insert into pedido (id, codigo, subtotal, taxa_frete, valor_total, restaurante_id, usuario_cliente_id, forma_pagamento_id, 
endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro, 
status, data_criacao, data_confirmacao, data_cancelamento, data_entrega) 
values (2, 'f9e6c528-2b43-466d-8f74-5ebb9212d889', 150.90, 3.80, 149.70, 1, 2, 2, 1, 0552101, 'rua conceicao', 456, null, 'Vila Antonieta', 'CONFIRMADO', 
'2021-05-20 19:42:07', '2021-05-20 19:50:07', null, null);

insert into item_pedido (id, quantidade, preco_unitario, preco_total, observacao, pedido_id, produto_id) 
values(3, 3, 50.30, 150.90, 'sem cebola', 2, 3);
...
values (3, 'b5741512-8fbc-47fa-9ac1-b530354fc0ff', 1, 1, 1, 1, '38400-222', 'Rua Natal', '200', null, 'Brasil',
        'ENTREGUE', '2019-11-03 01:10:00', '2019-11-03 01:20:45', '2019-11-03 01:24:55', 110, 10, 120);
